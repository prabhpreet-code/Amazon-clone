...
function Home() {
  const handleMouseOver = (e) => {
    if (e.target.className !== "product__button") {
      e.target.style.boxShadow = "5px 5px 10px grey";
    } else if (e.path[1].className === "product") {
      e.path[1].style.boxShadow = "5px 5px 10px grey";
    }
  };
